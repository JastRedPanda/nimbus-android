...
## Сессия 2026-09-09 — дни недели и точки спарклайна (релиз 1.22)

- Недельный прогноз: полные названия дней вместо сокращений (`formatDayOfWeek` через локаль — заодно появился чешский, раньше падал на английский); первая буква заглавная, единообразно со «Сегодня»; шапка без фиксированной ширины, описание с троеточием
- Спарклайн: точки-бусины (цветное ядро + контрастное кольцо) и направляющие вниз к чипам — линия и колонки читаются как единая диаграмма
- Релиз **v1.22**

## Сессия 2026-09-09 — мелочи дневных карточек (релиз 1.23)

- Зазор 8dp между днём недели и значком (симметрично второй стороне), день с троеточием
- Ветер в недельном — через тире («5 - 15 м/с»), как диапазон
- Релиз **v1.23**