...
interface WeatherApi {
    ...
    suspend fun getForecast(
        ...
        @Query("hourly") hourly: String = "temperature_2m,precipitation,weather_code,wind_speed_10m,wind_direction_10m,relative_humidity_2m,apparent_temperature,uv_index",
